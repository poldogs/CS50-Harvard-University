        ...
        <div className="p-6 bg-white rounded shadow-md">
            {editMode ? (
                <form onSubmit={handleEditSubmit} className="flex flex-col items-center space-y-4">
                    ...
                    <input type="color" name="color" value={editedTask.color} onChange={handleInputChange} className="w-12 h-12 mb-2 border-2 border-gray-200 rounded" />                <button type="submit" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Save</button>
                </form>
            ) : (
                <>
                    ...
                    <form onSubmit={handleAddSubTask} className="flex items-center space-x-4">
                        <input type="text" value={newSubTask} onChange={(e) => setNewSubTask(e.target.value)} className="p-2 border-2 border-gray-200 rounded" />
                        <input type="date" className="p-2 border-2 border-gray-200 rounded" />
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Subtask</button>
                    </form>
                    <ul>
